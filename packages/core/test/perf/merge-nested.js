...
xs.prototype.merge = function(s) {
  return xs.merge(this, s)
}
...
const suite = Benchmark.Suite(
  'merge nested streams w/depth 2, 5, 10, 100 (' + n + ' items in each stream)'
)
const options = {
  defer: true,
  onError: function(e) {
